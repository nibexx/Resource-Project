   ...
   <template>
    <div class="background">
        <keep-alive>
            ...
            <location-manager v-else @upload="handleUpload"></location-manager>
        </keep-alive>
    </div>
</template>
...
// Function to handle the upload event from LocationManager component
const handleUpload = () => {
  state.isFlag = false; // Hide the LocationManager component
  store.commit('setFlag', false); // Also update Vuex store if needed
};
</script>
